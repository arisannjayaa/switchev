...
document.addEventListener('DOMContentLoaded', function() {
    ...
    $("#table").DataTable({
        ...
        columns: [
            ...
            { data: 'sk_file_name', name: 'sk_file_name', className: 'text-nowrap', orderable: false, searchable: true},
            { data: 'sft_file_name', name: 'sft_file_name', className: 'text-nowrap', orderable: false, searchable: true},
