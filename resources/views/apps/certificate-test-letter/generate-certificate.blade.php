            ...
            <div class="alert alert-important alert-info" role="alert">
                <div class="d-flex align-items-center justify-content-between">
                    <div class="d-flex">
                        ...
                        <span class="alert-heading">SK dan Lampiran bisa diunduh disini</span>
                    </div>
...
//                $extension_certificate_attachment = pathinfo(@$test_letter->certificate->certificate_attachment, PATHINFO_EXTENSION);
        @endphp
        @if(@$test_letter->certificate->status != 'SUT Terverifikasi' || @$test_letter->certificate->status != 'SRUT SUT Terverifikasi')
            <div class="alert alert-important alert-info" role="alert">
                <div class="d-flex align-items-center justify-content-between">
                    <div class="d-flex">
                        <div class="alert-icon">
                        ...
                        <span class="alert-heading">Kirim draft dulu untuk di verifikasi, lalu upload berkas</span>
                    </div>
                </div>
            </div>
        @endif

        @if(@$test_letter->certificate->status == 'SUT Terverifikasi')
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        @if(@$test_letter->workshop_type == "A")
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    <label class="form-label required">Surat Keterangan dan Lampiran</label>
        ...
        @if(@$test_letter->certificate->status == 'SRUT SUT Terverifikasi')
            <div class="card">
                <div class="card-header">
                    <div class="card-title">Upload File</div>
                </div>
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <small class="form-hint">
                                        ...
                                        Upload file dalam bentuk pdf hasil dari sertifikat srut
                                    </small>
                                </div>
                            </div>
                            <div class="mb-3">
...
@section('url')
    ...
    <input type="hidden" id="download-certificate-attachment-url" value="{{ route('certificate.test.letter.generate.certificate.attachment') }}">
