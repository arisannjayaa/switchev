            ...
            <form id="form-user">
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <div>
                            <input readonly type="text" class="form-control" aria-describedby="emailHelp" placeholder="Joko Widodo" name="name" id="name">
                    ...
                    <div class="mb-3">
                        ...
                        <div>
                            <input readonly type="email" class="form-control" aria-describedby="emailHelp" placeholder="Enter email" name="email" id="email">
...
{{--                        <div>--}}
{{--                            <input readonly type="password" class="form-control" placeholder="Password" name="password" id="password">--}}
...
{{--                        <div>--}}
{{--                            <input readonly type="text" class="form-control" placeholder="telepon" name="telephone" id="telephone">--}}
{{--                            <small class="form-hint">--}}
