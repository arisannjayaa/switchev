                        ...
                        <div class="row row-cards">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="Tegangan Kerja Motor (Volt)" id="voltage_drive_motor" name="voltage_drive_motor" value="{{ @$drive_motor->voltage }}">
                                    <small class="form-hint">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="Arus Maksimum Motor (Ampere)" id="ampere_drive_motor" name="ampere_drive_motor" value="{{ @$drive_motor->ampere }}">
                                    <small class="form-hint">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="Daya Motor (kW)" id="power_drive_motor" name="power_drive_motor" value="{{ @$drive_motor->power }}">
                                    <small class="form-hint">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="Daya Motor Maksimum (kW)" id="power_max_drive_motor" name="power_max_drive_motor" value="{{ @$drive_motor->power_max }}">
                                    <small class="form-hint">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="Putaran Maksimum Motor (rpm)" id="rotation_drive_motor" name="rotation_drive_motor" value="{{ @$drive_motor->rotation }}">
                                    <small class="form-hint">
                        ...
                        <div class="row row-cards">
                            <div class="col-md-6 col-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="Tegangan Kerja Sistem Konversi (Volt)" id="conversion_voltage_fuel_system" name="conversion_voltage_fuel_system" value="{{ @$fuel_system->conversion_voltage }}">
                                    <small class="form-hint">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="Tegangan Kerja Kelistrikan Kendaraan (Volt)" id="electrical_voltage_fuel_system" name="electrical_voltage_fuel_system" value="{{ @$fuel_system->electrical_voltage }}">
                                    <small class="form-hint">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="Kapasitas Baterai (kWh)" id="battery_capacity_fuel_system" name="battery_capacity_fuel_system" value="{{ @$fuel_system->battery_capacity }}">
                                    <small class="form-hint">
                        ...
                        <div class="row row-cards">
                            <div class="col-md-6 col-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="Panjang Total (mm)" id="total_length_vehicle_dimension" name="total_length_vehicle_dimension" value="{{ @$vehicle_dimension->total_length }}">
                                    <small class="form-hint">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="Lebar Total (mm)" id="total_width_vehicle_dimension" name="total_width_vehicle_dimension" value="{{ @$vehicle_dimension->total_width }}">
                                    <small class="form-hint">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="Tinggi Total (mm)" id="total_height_vehicle_dimension" name="total_height_vehicle_dimension" value="{{ @$vehicle_dimension->total_height }}">
                                    <small class="form-hint">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="Jarak Sumbu I-II (mm)" id="axis_distance_vehicle_dimension" name="axis_distance_vehicle_dimension" value="{{ @$vehicle_dimension->axis_distance }}">
                                    <small class="form-hint">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="Julur Depan (Front Over Hang) (mm)" id="front_over_vehicle_dimension" name="front_over_vehicle_dimension" value="{{ @$vehicle_dimension->front_over }}">
                                    <small class="form-hint">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="Julur Belakang (Front Over Hang) (mm)" id="rear_over_vehicle_dimension" name="rear_over_vehicle_dimension" value="{{ @$vehicle_dimension->rear_over }}">
                                    <small class="form-hint">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="Julur Bebas (Ground Clearance) (mm)"  id="ground_clearance_vehicle_dimension" name="ground_clearance_vehicle_dimension" value="{{ @$vehicle_dimension->ground_clearance }}">
                                    <small class="form-hint">
                    ...
                    @if($form_step == 8)
                        ...
                        <div class="row row-cards">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-3">
                                    <label class="form-label required">Sumbu I</label>
                                    <input type="text" class="form-control" placeholder="Sumbu I" id="axis_1_empty_vehicle_weight" name="axis_1_empty_vehicle_weight" value="{{ @$vehicleWeight->axis_1_empty_vehicle_weight }}">
                                    <small class="form-hint">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-3">
                                    <label class="form-label required">Sumbu II</label>
                                    <input type="text" class="form-control" placeholder="Sumbu II" id="axis_2_empty_vehicle_weight" name="axis_2_empty_vehicle_weight" value="{{ @$vehicleWeight->axis_2_empty_vehicle_weight }}">
                                    <small class="form-hint">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-3">
                                    <label class="form-label required">Sumbu I</label>
                                    <input type="text" class="form-control" placeholder="Sumbu I" id="axis_1_axis_design_strength" name="axis_1_axis_design_strength" value="{{ @$vehicleWeight->axis_1_axis_design_strength }}">
                                    <small class="form-hint">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-3">
                                    <label class="form-label required">Sumbu II</label>
                                    <input type="text" class="form-control" placeholder="Sumbu II" id="axis_2_axis_design_strength" name="axis_2_axis_design_strength" value="{{ @$vehicleWeight->axis_2_axis_design_strength }}">
                                    <small class="form-hint">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-3">
                                    <label class="form-label required">Sumbu I</label>
                                    <input type="text" class="form-control" placeholder="Sumbu I" id="axis_1_jbb" name="axis_1_jbb" value="{{ @$vehicleWeight->axis_1_jbb }}">
                                    <small class="form-hint">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-3">
                                    <label class="form-label required">Sumbu II</label>
                                    <input type="text" class="form-control" placeholder="Sumbu II" id="axis_2_jbb" name="axis_2_jbb" value="{{ @$vehicleWeight->axis_2_jbb }}">
                                    <small class="form-hint">
                        ...
                        <div class="row row-cards" style="max-height: 100dvh; overflow: hidden; overflow-y: scroll;">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="Jumlah" id="main_light_amount_other" name="main_light_amount_other" value="{{ @$other->main_light_amount }}">
                                </div>
                            </div>
                            <div class="col-md-6 col-12">
                                <div class="mb-3">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="Daya" id="main_light_power_other" name="main_light_power_other" value="{{ @$other->main_light_power }}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="Jumlah" id="center_light_amount_other" name="center_light_amount_other" value="{{ @$other->center_light_amount }}">
                                </div>
                            </div>
                            <div class="col-md-6 col-12">
                                <div class="mb-3">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="Daya" id="center_light_power_other" name="center_light_power_other" value="{{ @$other->center_light_power }}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-3">
                                    <label class="form-label">Jumlah</label>
                                    <input type="text" class="form-control" placeholder="Jumlah" id="side_light_amount_other" name="side_light_amount_other" value="{{ @$other->side_light_amount }}">
                                </div>
                            </div>
                            <div class="col-md-6 col-12">
                                <div class="mb-3">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-3">
                                    <label class="form-label">Daya</label>
                                    <input type="text" class="form-control" placeholder="Daya" id="side_light_power_other" name="side_light_power_other" value="{{ @$other->side_light_power }}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-3">
                                    <label class="form-label">Jumlah</label>
                                    <input type="text" class="form-control" placeholder="Jumlah" id="number_plate_light_amount_other" name="number_plate_light_amount_other" value="{{ @$other->number_plate_light_amount }}">
                                </div>
                            </div>
                            <div class="col-md-6 col-12">
                                <div class="mb-3">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-3">
                                    <label class="form-label">Daya</label>
                                    <input type="text" class="form-control" placeholder="Daya" id="number_plate_light_power_other" name="number_plate_light_power_other" value="{{ @$other->number_plate_light_power }}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-3">
                                    <label class="form-label required">Jumlah</label>
                                    <input type="text" class="form-control" placeholder="Jumlah" id="stop_light_amount_other" name="stop_light_amount_other" value="{{ @$other->stop_light_amount }}">
                                </div>
                            </div>
                            <div class="col-md-6 col-12">
                                <div class="mb-3">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-3">
                                    <label class="form-label required">Daya</label>
                                    <input type="text" class="form-control" placeholder="Daya" id="stop_light_power_other" name="stop_light_power_other" value="{{ @$other->stop_light_power }}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-3">
                                    <label class="form-label">Jumlah</label>
                                    <input type="text" class="form-control" placeholder="Jumlah" id="reverse_light_amount_other" name="reverse_light_amount_other" value="{{ @$other->reverse_light_amount }}">
                                </div>
                            </div>
                            <div class="col-md-6 col-12">
                                <div class="mb-3">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-3">
                                    <label class="form-label">Daya</label>
                                    <input type="text" class="form-control" placeholder="Daya" id="reverse_light_power_other" name="reverse_light_power_other" value="{{ @$other->reverse_light_power }}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-3">
                                    <label class="form-label required">Jumlah</label>
                                    <input type="text" class="form-control" placeholder="Jumlah" id="front_turn_signal_light_amount_other" name="front_turn_signal_light_amount_other" value="{{ @$other->front_turn_signal_light_amount }}">
                                </div>
                            </div>
                            <div class="col-md-6 col-12">
                                <div class="mb-3">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-3">
                                    <label class="form-label required">Daya</label>
                                    <input type="text" class="form-control" placeholder="Daya" id="front_turn_signal_light_power_other" name="front_turn_signal_light_power_other" value="{{ @$other->front_turn_signal_light_power }}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-3">
                                    <label class="form-label required">Jumlah</label>
                                    <input type="text" class="form-control" placeholder="Jumlah" id="rear_turn_signal_light_amount_other" name="rear_turn_signal_light_amount_other" value="{{ @$other->rear_turn_signal_light_amount }}">
                                </div>
                            </div>
                            <div class="col-md-6 col-12">
                                <div class="mb-3">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-3">
                                    <label class="form-label required">Daya</label>
                                    <input type="text" class="form-control" placeholder="Daya" id="rear_turn_signal_light_power_other" name="rear_turn_signal_light_power_other" value="{{ @$other->rear_turn_signal_light_power }}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-3">
                                    <label class="form-label">Jumlah</label>
                                    <input type="text" class="form-control" placeholder="Jumlah" id="side_turn_signal_light_amount_other" name="side_turn_signal_light_amount_other" value="{{ @$other->side_turn_signal_light_amount }}">
                                </div>
                            </div>
                            <div class="col-md-6 col-12">
                                <div class="mb-3">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-3">
                                    <label class="form-label">Daya</label>
                                    <input type="text" class="form-control" placeholder="Daya" id="side_turn_signal_light_power_other" name="side_turn_signal_light_power_other" value="{{ @$other->side_turn_signal_light_power }}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-3">
                                    <label class="form-label">Jumlah</label>
                                    <input type="text" class="form-control" placeholder="Jumlah" id="additional_light_amount_other" name="additional_light_amount_other" value="{{ @$other->additional_light_amount }}">
                                </div>
                            </div>
                            <div class="col-md-6 col-12">
                                <div class="mb-3">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-3">
                                    <label class="form-label">Daya</label>
                                    <input type="text" class="form-control" placeholder="Daya" id="additional_light_power_other" name="additional_light_power_other" value="{{ @$other->additional_light_power }}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-3">
                                    <label class="form-label">Jumlah</label>
                                    <input type="text" class="form-control" placeholder="Jumlah" id="reflector_light_amount_other" name="reflector_light_amount_other" value="{{ @$other->reflector_light_amount }}">
                                </div>
                            </div>
                            <div class="col-md-6 col-12">
                                <div class="mb-3">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-3">
                                    <label class="form-label">Daya</label>
                                    <input type="text" class="form-control" placeholder="Daya" id="reflector_light_power_other" name="reflector_light_power_other" value="{{ @$other->reflector_light_power }}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-3">
                                    <label class="form-label">Jumlah</label>
                                    <input type="text" class="form-control" placeholder="Jumlah" id="fog_light_amount_other" name="fog_light_amount_other" value="{{ @$other->fog_light_amount }}">
                                </div>
                            </div>
                            <div class="col-md-6 col-12">
                                <div class="mb-3">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-3">
                                    <label class="form-label">Daya</label>
                                    <input type="text" class="form-control" placeholder="Daya" id="fog_light_power_other" name="fog_light_power_other" value="{{ @$other->fog_light_power }}">
                                </div>
                            </div>
