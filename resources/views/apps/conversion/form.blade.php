                ...
                <div class="row row-cards">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" placeholder="Nama penanggung jawab" name="person_responsible">
                        </div>
                    </div>
                    <div class="col-sm-6 col-md-6">
                        <div class="mb-3">
                            <label class="form-label required">No Whatsapp</label>
                            <input type="text" class="form-control" placeholder="No Whatsapp" name="whatapp_responsible">
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" placeholder="Nama Bengkel Konversi" name="workshop">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
                    ...
                    <div class="col-md-12">
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="address" rows="6" placeholder="Alamat.."></textarea>
                        </div>
                    </div>
