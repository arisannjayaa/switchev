                    ...
                    <div class="alert alert-important alert-danger" role="alert">
                        <div class="d-flex">
                            ...
                            <div>
                                ...
                                <span class="text-secondary"> {!! @$conversion->message !!}<span class="">Silahkan perbaiki data pada link berikut ini.</span> <a href="{{ route('conversion.form', ['step' => 1, 'id' =>  \App\Helpers\Helper::encrypt(@$conversion->id)]) }}">Perbaiki data</a></span>
                            </div>
                        </div>
                    </div>
                @endif
