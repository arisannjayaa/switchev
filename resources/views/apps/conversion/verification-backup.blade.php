...
@section('content')
            ...
            <div class="col-lg-8 col-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div id="editor">
                                    ...
                                    <p>Terima kasih,</p>
                                    <p><strong>Admin Switch EV</strong></p>
                                </div>
                            </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="alert alert-important alert-info" role="alert">
                                        <div class="d-flex">
                                            ...
                                            <div>
                                                ...
                                                <div class="alert-description">
                                                    <span>Anda sudah pernah mengirimkan email sebelumnya sebanyak {{ $conversion->field_mail_attempt . " kali" }}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div id="editor">
                                    ...
                                    <p>Jika Anda memiliki pertanyaan lebih lanjut atau membutuhkan bantuan terkait tempat dan waktu, jangan ragu untuk menghubungi kami di <strong>switchev21@gmail.com</strong>.</p>
                                </div>
                            </div>
                            <div class="card-footer text-end">
                                <button id="btn-send-mail" type="submit" class="btn btn-primary">Kirim Email</button>
                ...
                @if($conversion->step == 4)
                    <div class="alert alert-important alert-info" role="alert">
                        <div class="d-flex">
                            ...
                            <div>
                                <h4 class="alert-heading">Tinggal Satu Langkah Lagi</h4>
                                <div class="alert-description">
                                    <p class="d-inline">Admin, untuk menyelesaikan tahapan klik tombol selesai. Selanjutnya Buat Sertifikat dan Surat Keterangan</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                @if($conversion->step == 5)
                    <div class="d-flex justify-content-center align-items-center text-center flex-column">
                        ...
                        <a href="#" class="btn btn-outline-primary">Buat Sertifikat dan Surat Keterangan</a>
                    </div>
                @endif
            </div>
    ...
    @include('apps.conversion.checlist-modal')
@endsection
...
@section('script')
    ...
    @if($conversion->step == 4) @vite(['resources/js/apps/certificate/certificate.js']) @endif
