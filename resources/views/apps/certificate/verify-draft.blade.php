                        ...
                        <div class="card-body">
                            <div class="row">
                                @php
                                    ...
                                    $attachments[] = $certificate->sft_attachment;
                                @endphp
...
@section('url')
    <input type="hidden" id="verify-url" value="{{ route('certificate.verification') }}">
@endsection

@section('script')
    @vite(['resources/js/apps/certificate/certificate.js'])
@endsection
