...
<li class="nav-item {{ request()->is('pelayanan/sut-srut*') ? 'active' : '' }}">
    <a class="nav-link" href="{{ route('certificate.test.letter.index') }}">
      <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/checkbox -->
        <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24"
             stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round"
             stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path
        ...
        <span class="nav-link-title">
            Permohonan Sertifikasi SRUT dan SUT
        </span>
    </a>
</li>
<li class="nav-item {{ request()->is('pelayanan/sut-srut/bpljskb') ? 'active' : '' }}">
    <a class="nav-link" href="{{ route('certificate.test.letter.index') }}">
      <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/checkbox -->
        <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24"
             stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round"
