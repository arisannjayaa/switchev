    ...
    public function table()
    {
        return DataTables::of($this->mainRepository->table())
            ...
            ->addColumn('action', function ($row) {
                $verificationMenu = '<button class="dropdown-item detail" href="javascript:void(0)" data-id="'.$row->id.'">
                                  Lihat
                                </button>';
                if ($row->step == "step-2") {
                    $verificationMenu .= '<button class="dropdown-item verification-zoom" href="javascript:void(0)" data-id="'.$row->id.'">
                                  Verifikasi Zoom
                                </button>';
                }

                if ($row->step == "step-3") {
                    $verificationMenu .= '<button class="dropdown-item verification-field" href="javascript:void(0)" data-id="'.$row->id.'">
                                  Verifikasi Lapangan
                                </button>';
                }
